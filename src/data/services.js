...
const SERVICE_DATA = {
    ...
    wholesale: {
        ...
        desc: "An established and successful Indian manufacturer of natural personal care products is seeking wholesalers, distributors, importers and retail partners across Africa.",
        icon: "🌿",
        formTitle: "Wholesale Partnership Eligibility",
        about: {
            heading: "A Premium Range for a Growing Market",
            body: "Demand for natural personal care products across Africa continues to grow. Our manufacturing partner is an established Indian producer offering a comprehensive range of high-quality products designed for a variety of skin and hair care needs.",
            body2: "We are seeking experienced trade partners who can help introduce these products to new markets. Whether you operate a retail chain, pharmacy network, wholesale business or import operation, we would be pleased to discuss potential opportunities.",
        },
        features: [
            { icon: "🧼", text: "Natural soaps made from carefully selected ingredients." },
            { icon: "💆", text: "Herbal hair care products designed for growing consumer demand." },
            { icon: "✨", text: "Natural skincare products suitable for a wide range of skin types." },
            { icon: "📦", text: "Flexible ordering options, from individual products to full product ranges." },
            { icon: "🌍", text: "Potential exclusive distribution opportunities, subject to territory and agreement." },
